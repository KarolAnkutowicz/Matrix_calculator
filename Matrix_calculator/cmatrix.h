...
/********** PRIVATE: BEGINNING **********/
    ...
    /*
     * double *tableElements - tablica przechowujaca wartosci elementow
     * macierzy
     */
    double *tableElements;
    /*
     * bool vIfVector - pole przechowujace informacje czy macierz
     * jest wektorem
     */
    bool vIfVector;
    /*
     * bool vIfMatrixZeros - pole przechowujace informacje czy
     * macierz jest macierza zerowa
     */
    bool vIfMatrixZeros;
    /*
     * bool vIfMatrixSquare - pole przechowujace informacje czy
     * macierz jest macierza kwadratowa
     */
    bool vIfMatrixSquare;
    /*
     * bool vIfMatrixIdentity - pole przechowujace informacje czy
     * macierz jest macierza jednostkowa
     */
    bool vIfMatrixIdentity;
    /*
     * bool vIfMatrixDiagonal - pole przechowujace informacje czy
     * macierz jest macierza diagonalna
     */
    bool vIfMatrixDiagonal;
    /*
     * bool vIfMatrixTriangularUpper - pole przechowujace informacje
     * czy macierz jest macierza trojkatna gorna
     */
    bool vIfMatrixTriangularUpper;
    /*
     * bool vIfMatrixTriangularLower - pole przechowujace informacje
...
public:
     ...
     * - podanie referencji do obiektu klasy cMatrix.
     * POST:
     * - zwrocenie obiektu wynikowego (typ: cMatrix).
     */
